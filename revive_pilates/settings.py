...
try:
    ...
    SECURITY_CONFIG = {
        ...
        'DEBUG': True,
        'ALLOWED_HOSTS': ['*', 'config.revivepilates.com', 'admin.revivepilates.com', 'booking.revivepilates.com', '*.vercel.app', 'revive-back.vercel.app', 'revive-back-qhr0wfze1-eduardordevs-projects.vercel.app'],
    }
    CORS_CONFIG = {
