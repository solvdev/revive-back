...
from .models import ClassType, PromotionInstance, Schedule, Membership, Payment, Booking, PlanIntent, MonthlyRevenue, Promotion, Venta, BulkBooking, Sede
...
class ScheduleAdmin(admin.ModelAdmin):
    list_display = ('day', 'get_time_slot_display', 'is_individual', 'capacity', 'sede')
...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ('id', 'client', 'membership', 'amount', 'date_paid', 'valid_until', 'extra_classes', 'sede')
...
class MonthlyRevenueAdmin(admin.ModelAdmin):
    list_display = ('year', 'month', 'total_amount', 'payment_count', 'last_updated', 'sede')
    list_filter = ('year', 'month', 'sede')
    ordering = ('-year', '-month')
    
@admin.register(Promotion)
class PromotionAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'membership', 'price', 'start_date', 'end_date', 'scope', 'sede')
...
class VentaAdmin(admin.ModelAdmin):
    list_display = ('id', 'client', 'product_name', 'quantity', 'price_per_unit', 'total_amount', 'payment_method', 'date_sold', 'sede')
...
class BulkBookingAdmin(admin.ModelAdmin):
    list_display = ('id', 'client', 'status', 'total_bookings', 'successful_bookings', 'failed_bookings', 'created_at', 'sede')
    list_filter = ('status', 'created_at', 'sede')
    search_fields = ('client__first_name', 'client__last_name')
    date_hierarchy = 'created_at'
    readonly_fields = ('total_bookings', 'successful_bookings', 'failed_bookings', 'created_at', 'updated_at')
