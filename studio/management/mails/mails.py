    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px;">
            ...
            <div style="background-color: #e8f5e8; padding: 20px; border-radius: 8px; margin: 20px 0;">
                ...
                <p><strong>Clase:</strong> {booking.schedule.class_type.name}</p>
                <p><strong>Fecha:</strong> {booking.schedule.date}</p>
                <p><strong>Hora:</strong> {booking.schedule.start_time}</p>
                <p><strong>Instructor:</strong> {booking.schedule.instructor.name if booking.schedule.instructor else 'Por asignar'}</p>
            </div>
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px;">
            ...
            <div style="background-color: #e8f5e8; padding: 20px; border-radius: 8px; margin: 20px 0;">
                ...
                <ul>
                    {''.join([f'<li><strong>{booking.schedule.class_type.name}</strong> - {booking.schedule.date} a las {booking.schedule.start_time}</li>' for booking in bookings])}
                </ul>
            </div>
